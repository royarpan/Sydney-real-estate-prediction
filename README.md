...
Edit line 7 and 8 of code in realestatepredictor.py to initialize data, in line 7 add s=suburb name (e.g., "North Ryde"), in line 8 add the line=line of data from realestatedata.txt for that suburb)
