...
print("Suburb name: North Sydney") #North Sydney
#Sample house prices
#House prices data obtained at: http://www.yourinvestmentpropertymag.com.au/top-suburbs/nsw-2060-north-sydney.aspx
house=np.zeros(100)
y1=1912.5 #*1000 in 2015
...
mean_growthy1=0.0838 #Average annual growth
#sigma_growth=sqrt(annual growth in 2015-average annual growth)
sigma_growthy1=0.1979
...
#Unit prices data obtained at: http://www.yourinvestmentpropertymag.com.au/top-suburbs/nsw-2060-north-sydney.aspx
unit=np.zeros(100)
y2=794 #*1000 in 2015
#Assuming 2015's average annual growth as median year on year growth
#Samples are generated from a normal distribution with mean=Average annual growth in 2015
#and standard deviation=annual growth in 2015-average annual growth
mean_growthy2=0.0606 #Average annual growth
#sigma_growth=sqrt(annual growth in 2015-average annual growth)
sigma_growthy2=0.015
...
#Employment numbers for north sydney from: Page 14 of http://www.planning.nsw.gov.au/~/media/Files/DPE/Reports/forecasting-the-distribution-of-stand-alone-office-employment-within-sydney-to-2035-2014-08.ashx
...
mean_growthx1=0.683 #*1000 annual growth
sigma_growthx1=0.3444
growth_x1=np.random.normal(mean_growthx1, sigma_growthx1, 112)
numemployed[99]=42 #*1000 in 2015
for i in range(1,99):
...
for i in range(1,11):
	test_x1[i]=test_x1[i]+growth_x1[100+i]*test_x1[i] #computing upcoming years' (after 2015) no. of jobs

#historical walk score of north sydney
#obtained from https://www.walkscore.com/AU-NSW/Sydney/North_Sydney
...
walkscore[99]=92 #walkscore in 2015
for i in range(1,99):
...
d5={'three':unit}
Y1_train=pd.DataFrame(d5) #Output dataframe from linear regression
regr = linear_model.LinearRegression()
