...
s="North Ryde"
line="North Ryde 1430000 9.74 1.98 895000 6.1 5.42 38000 1440 496.38 62" 
strlen=len(s)
line=line[strlen:]
tokens=line.split()
index=0
...
print "Prediction accuracy for house price= ",pred_acc,"%"
...
print "HOUSE PRICES-- 2017: ",Y[1],"K 2018: ",Y[2],"K 2022: ",Y[6],"K 2027: ",Y[7],"K"
...
pred_acc=pred_acc*100/20
print "Prediction accuracy for unit price= ",pred_acc,"%"

Y1=regr.predict(X_test) #Compute predicted unit prices for the next 12 years for same test set
print "UNIT PRICES-- 2017: ",Y1[1],"K 2018: ",Y1[2],"K 2022: ",Y1[6],"K 2027: ",Y1[7],"K"