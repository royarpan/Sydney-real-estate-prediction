...
print("Suburb name: Parramatta") #North Ryde
#Sample house prices
...
mean_growthy1=0.0878 #Average annual growth
...
#and standard deviation=annual growth in 2015-average annual growth
mean_growthy2=0.0683 #Average annual growth
#sigma_growth=sqrt(annual growth in 2015-average annual growth)
sigma_growthy2=0.353
...
mean_growthx1=4.1 #*1000 annual growth
sigma_growthx1=0.234
growth_x1=np.random.normal(mean_growthx1, sigma_growthx1, 112)
numemployed[99]=37 #*1000 in 2015
for i in range(1,99):
